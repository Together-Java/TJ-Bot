...
/**
 * Declares a single argument a {@link ChatGptTool} accepts. Used to build the JSON schema sent to
 * OpenAI so the model knows which arguments to produce on a tool call.
 *
 ...
 *        it as optional
 */
public record Parameter(String name, String description, ParameterType type, boolean required) {
}
