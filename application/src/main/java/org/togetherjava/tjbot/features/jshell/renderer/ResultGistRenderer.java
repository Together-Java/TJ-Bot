...
class ResultGistRenderer {
     ...
     * @return the content
     */
    public Optional<MessageEmbed> renderToGist(String gistApiToken, @Nullable Member originator, boolean showCode, JShellResult result) {
        ...
        try {
            ...
            gistBuilder.file((originator == null ? "JShell" : originator.getEffectiveName()) + "'s result.java", text);
