...
/**
 * Utility class that offers all commands that should be registered by the system. New commands have to be added here,
 * where {@link org.togetherjava.tjbot.commands.system.CommandSystem} will then pick it up from and register it with the
 * system.
 * <p>
 * To add a new slash command, extend the commands returned by {@link #createSlashCommands(Database)}.
 */
public enum Commands {
	 ...
	 * <p>
	 * Calling this method multiple times will result in multiple commands being created, which generally should be
	 * avoided.
	 *
