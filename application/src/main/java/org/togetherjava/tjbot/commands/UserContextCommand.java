 ...
 * commands ({@link #onUserContext(UserContextInteractionEvent)}), buttons
...
public interface UserContextCommand extends BotCommand {
    ...
    /**
     * Triggered by the core system when a user context-command corresponding to this implementation (based
