 ...
 * commands ({@link #onSlashCommand(SlashCommandInteraction)}), buttons
...
public interface SlashCommand extends Feature {
     ...
     */
    void onSlashCommand(@NotNull SlashCommandInteraction event);
     ...
     *        {@link #onSlashCommand(SlashCommandInteraction)} for details on how these are created
     */
     ...
     * button or selection menus. See {@link #onSlashCommand(SlashCommandInteraction)} for details on how
     * to use this.
     *
