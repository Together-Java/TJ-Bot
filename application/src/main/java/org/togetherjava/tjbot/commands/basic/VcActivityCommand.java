...
public final class VcActivityCommand extends SlashCommandAdapter {
    ...
    private static void handleSubcommand(@NotNull SlashCommandInteraction event,
    ...
    private static @NotNull ReplyCallbackAction replyInvite(@NotNull SlashCommandInteraction event,
    ...
    private static void handleErrors(@NotNull SlashCommandInteraction event,
